...
# from Calibration_class import IBM4Cal
...
# Current_Control.Current(Current=20, Max_V=3.3, delay = 1)
# Current_Control.other_sweep_current(Max_V=3.1, start=0, end=40, steps=100, Min_delay=0.1)
Current_Control.IV_diagram(Max_V=3.3, start=0, end=40, steps=100, Min_delay=0)
